...
class StableDiffusionPipelinePartialInversion(StableDiffusionPix2PixZeroPipeline):
    ...
    def denoise(
        ...
        if return_latent:
            ...
            if not return_dict:
                ...
                ret = StableDiffusionPipelineOutput(images=image, nsfw_content_detected=[False] * numimg)
    ...
    def compute_stepwise_reconstruction_distance(self, x0 : PIL.Image.Image, 
        ...
        x_extra_recon = self.denoise(prompt, latents=x_inv_extra.latents, denoise_from=num_inference_steps-reconstruction_steps-extra_steps, 
...
def create_pipeline(sd_model_ckpt='runwayml/stable-diffusion-v1-5', 
